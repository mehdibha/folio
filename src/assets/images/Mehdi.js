...
const letterProps = (delay) => ({
    variants: path,
    initial: "hidden",
    animate: "visible",
    transition: {
        default: { delay,duration: 1, ease: "linear" },
    },
});

const rectProps = (delay) => ({
    variants: path,
    initial: "hidden",
    animate: "visible",
    transition: {
        default: { delay,duration: 3, ease: "easeIn" },
    },
});
...
const Mehdi = (props) => {
    return (
        ...
        >
            ...
            <g fill="none" stroke='#FFF' strokeWidth={7} strokeMiterlimit={10}>
                <motion.path
                    {...letterProps(0)}
                    clipPath="url(#m)"
